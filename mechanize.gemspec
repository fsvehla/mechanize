...
Gem::Specification.new do |s|
  s.name = %q{mechanize}
  s.version = "1.0.0.20100903115223"
...
a history.}
  ...
  s.extra_rdoc_files = ["Manifest.txt", "CHANGELOG.rdoc", "LICENSE.rdoc", "GUIDE.rdoc", "FAQ.rdoc", "README.rdoc", "EXAMPLES.rdoc"]
  ...
  s.test_files = ["test/test_scheme.rb", "test/test_errors.rb", "test/test_multi_select.rb", "test/test_ssl_server.rb", "test/test_radiobutton.rb", "test/test_redirect_limit_reached.rb", "test/test_request.rb", "test/test_relative_links.rb", "test/test_textarea.rb", "test/test_mech.rb", "test/test_pluggable_parser.rb", "test/test_select_all.rb", "test/test_form_no_inputname.rb", "test/test_links.rb", "test/test_forms.rb", "test/test_mech_proxy.rb", "test/test_mechanize_file.rb", "test/test_cookie_class.rb", "test/test_util.rb", "test/test_get_headers.rb", "test/test_redirect_verb_handling.rb", "test/test_verbs.rb", "test/test_response_code.rb", "test/test_save_file.rb", "test/test_pretty_print.rb", "test/chain/test_parameter_resolver.rb", "test/chain/test_auth_headers.rb", "test/chain/test_custom_headers.rb", "test/chain/test_header_resolver.rb", "test/chain/test_response_reader.rb", "test/chain/test_request_resolver.rb", "test/chain/test_argument_validator.rb", "test/test_bad_links.rb", "test/test_form_as_hash.rb", "test/test_gzipping.rb", "test/test_meta.rb", "test/test_authenticate.rb", "test/test_select_none.rb", "test/test_content_type.rb", "test/test_hash_api.rb", "test/test_follow_meta.rb", "test/test_select_noopts.rb", "test/test_no_attributes.rb", "test/test_frames.rb", "test/test_if_modified_since.rb", "test/test_select.rb", "test/test_html_unscape_forms.rb", "test/test_upload.rb", "test/test_form_button.rb", "test/test_post_form.rb", "test/test_page.rb", "test/test_referer.rb", "test/test_blank_form.rb", "test/test_headers.rb", "test/test_history_added.rb", "test/test_checkboxes.rb", "test/test_history.rb", "test/test_encoded_links.rb", "test/test_cookie_jar.rb", "test/test_field_precedence.rb", "test/test_cookies.rb", "test/test_set_fields.rb", "test/test_subclass.rb", "test/test_form_action.rb", "test/test_option.rb"]
